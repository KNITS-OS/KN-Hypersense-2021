...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_STATE),
          REQUEST(ACTION_TYPES.UPDATE_STATE),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_STATE),
          REQUEST(ACTION_TYPES.DELETE_STATE),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_STATE),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_STATE actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_STATE),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_STATE),
          payload: resolvedObject,
        },
      ];
